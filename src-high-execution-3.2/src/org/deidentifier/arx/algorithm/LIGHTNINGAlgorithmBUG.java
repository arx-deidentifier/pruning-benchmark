 ...
 */
public class LIGHTNINGAlgorithmBUG extends AbstractAlgorithm{
    ...
    * @param timeLimit
    */
    private LIGHTNINGAlgorithmBUG(SolutionSpace space, NodeChecker checker, int timeLimit) {
        super(space, checker);
    ...
    */
     ...
     * @param transformation
     */
    private void bug(Transformation transformation) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            // Recursive call
            bug(solutionSpace.getTransformation(list.getQuick(i)));
    ...
    public static AbstractAlgorithm create(SolutionSpace solutionSpace,
                                           NodeChecker checker,
                                           int timeLimit) {
        return new LIGHTNINGAlgorithmBUG(solutionSpace, checker, timeLimit);
    }
}
