 ...
 */
public class BenchmarkAnalysisMemoryHigh {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        series.append(getSeries("results/results-high-memory-3.1.csv", "Explicit implementation"));
        series.append(getSeries("results/results-high-memory-3.2.csv", "Implicit implementation"));
        
        List<Plot<?>> plots = new ArrayList<Plot<?>>();
        plots.add(new PlotLinesClustered("", 
                                         new Labels("Dataset", "Size of the solution space [MiB]"),
                                         series));
        ...
        params.size = 1.0d;
        params.ratio = 0.5d;
        groups.add(new PlotGroup("Comparison of the size of the solution space", plots, params, 1.0d));
        LaTeX.plot(groups, "results/high-memory", true);
    ...
    private static Series<Point3D> getSeries(String file, final String label) throws IOException {
        ...
        Series3D series = new Series3D(new CSVFile(new File(file)),  
                                       ...
                                       label,
                                       new Field("Space", Analyzer.VALUE));
        ...
        series.transform(new Function<Point3D>(){
            ...
            public Point3D apply(Point3D arg0) {
                return new Point3D(arg0.x,
                                   arg0.y,
                                   String.valueOf(Double.valueOf(arg0.z) / (1024*1024)));
            }
        });
