 ...
 */
public class BenchmarkAnalysisExecutionHighOptimal {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        series.append(getSeries("results/results-high-execution-3.1.csv", "Explicit implementation"));
        series.append(getSeries("results/results-high-execution-3.2.csv", "Implicit implementation"));
        ...
        LaTeX.plot(groups, "results/high-execution", true);
     ...
     * @throws ParseException 
     */
    private static Series<Point3D> getSeries(String file, final String label) throws IOException, ParseException {
        ...
        while (iter.hasNext()) {
            if (Integer.valueOf(iter.next().x) > 12) {
                iter.remove();
            }
        }
