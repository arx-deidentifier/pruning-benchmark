 ...
 */
public class BenchmarkAnalysisMemoryLow {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        series.append(getSeries("results/results-low-memory-3.1.csv", "Explicit implementation"));
        series.append(getSeries("results/results-low-memory-3.2.csv", "Implicit implementation"));
        ...
        LaTeX.plot(groups, "results/low-memory", true);
