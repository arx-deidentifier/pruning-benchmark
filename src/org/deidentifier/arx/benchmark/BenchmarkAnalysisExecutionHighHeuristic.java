 ...
 */
public class BenchmarkAnalysisExecutionHighHeuristic {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        series.append(getSeries("results/results-high-execution-3.2.csv"));
        ...
        LaTeX.plot(groups, "results/high-execution-heuristic", true);
     ...
     * @throws ParseException 
     */
    private static Series<Point3D> getSeries(String file) throws IOException, ParseException {
        ...
        series.append(new Series3D(csvfile,
                                   new Field("Attributes"),
                                   "Heuristic search",
