...
public class BenchmarkExperiment {
    ...
    private static final Benchmark BENCHMARK = new Benchmark(new String[] { "Dataset", "Utility", "Privacy", "Nodes", "Property" });
        ...
        for (BenchmarkDataset data : BenchmarkSetup.getDatasets()) {
            for (BenchmarkPrivacyModel criterion : getCriteria()) {
                for (BenchmarkUtilityMeasure measure : BenchmarkSetup.getUtilityMeasures()) {
                    ...
                    long nodes = anonymize(data, measure, criterion);
                    ...
                    for (String property : propertiesArray) {
                        BENCHMARK.addRun(data.toString(), measure.toString(), criterion.toString(), nodes, property);
                    ...
                    BENCHMARK.getResults().write(new File("results/results-low-jhpl-numbers-3.2.csv"));
     ...
     * @throws IOException
     */
    private static long anonymize(BenchmarkDataset dataset, BenchmarkUtilityMeasure measure, BenchmarkPrivacyModel criterion) throws IOException {
